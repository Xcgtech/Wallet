...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Xchange Core Xchange-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Xchange-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Xchange transaction") + "\n" +
              "  Xchange-tx [options] -create [commands]   " + _("Create hex-encoded Xchange transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Xchange transaction
