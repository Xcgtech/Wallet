...
#define BOOST_TEST_MODULE Xchange Test Suite

#include "test_Xchange.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_Xchange_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
