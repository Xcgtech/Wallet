    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Xchange Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xchange address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Xchange: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Xchange Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xchange Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xchange Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xchange addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xchange addresses"));
    ...
    openAction->setStatusTip(tr("Open a Xchange: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xchange Core help message to get a list with possible Xchange Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Xchange Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Xchange Core"); // default title
