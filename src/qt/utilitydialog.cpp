    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Xchange Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Xchange Core"));
...
All the Xchange in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 Xchange, 0.1 Xchange, 1 Xchange and 10 Xchange -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://Xchange.atlassian.net/wiki/display/DOC/PrivateSend\">https://Xchange.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Xchange Core is shutting down...") + "<br /><br />" +
