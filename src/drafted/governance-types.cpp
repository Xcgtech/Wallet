...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "XchangeNetwork") type = XchangeNetwork;
    if(strType == "XchangeNetworkVariable") type = XchangeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == XchangeNetwork) s = "XchangeNetwork";
    if(type == XchangeNetworkVariable) s = "XchangeNetworkVariable";
