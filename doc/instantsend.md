...
This mechanism has been integrated into Bitcore-Node-Xchange which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Xchange/insight-api-Xchange#web-socket-api](https://github.com/Xchange/insight-api-Xchange#web-socket-api)
* API: [https://github.com/Xchange/insight-api-Xchange#instantsend-transactions](https://github.com/Xchange/insight-api-Xchange#instantsend-transactions)
...
By default, the Xchange Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Xchange Core daemon:
