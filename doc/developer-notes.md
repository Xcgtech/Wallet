...
Xchange Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 8693.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9386 for connections and services them.
...
However, in open source software such as Xchange Core, where everyone uses
...
pay attention to for reviewers of Xchange Core code.

General Xchange Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Xchange Core uses tinyformat, which is type safe. Leave them out to avoid confusion
