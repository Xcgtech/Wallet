...
$(package)_config_opts += -plugin-sql-sqlite
...
define $(package)_preprocess_cmds
  ...
  sed -i.old "s/src_plugins.depends = src_sql src_xml src_network/src_plugins.depends = src_sql src_xml src_network/" qtbase/src/src.pro && \
  ...
  sed -i.bak "s|QMAKE_AR|INCLUDEPATH += $(host_prefix)/native/include/c++/v1/ \nQMAKE_AR|" qtbase/mkspecs/macx-clang-linux/qmake.conf && \
  sed -i.bak "s|\$$$$\$$$${CROSS_COMPILE}|$(host_prefix)/native/bin/\$$$$\$$$${CROSS_COMPILE}|" qtbase/mkspecs/macx-clang-linux/qmake.conf &&\
